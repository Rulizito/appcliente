...
class _OrderTrackingScreenState extends State<OrderTrackingScreen>
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip: _showMap ? 'Ver detalles' : 'Ver mapa',
          ),
        ],
      ),
          ...
          return _showMap
              ...
              : TabBarView(
                  ...
                  children: [
                    ...
                    // Detalles (segundo tab)
                    _buildDetailsView(order),
                  ],
                );
        },
      ),
  ...
  Widget _buildDetailsView(order_model.Order order) {
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          // Información del repartidor (si está en camino)
          if (order.status == 'on_way') ...[
            const SizedBox(height: 16),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              child: _buildDeliveryPersonCard(),
            ),
          ],
                  ...
                  if (order.status == 'on_way') ...[
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: const Text('Mensaje al repartidor'),
                        style: ElevatedButton.styleFrom(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            const SizedBox(width: 12),
            Text('Contactar al $type'),
          ],
        ),
        content: Text(
          'La función de contacto estará disponible próximamente.\n\nPodrás comunicarte directamente con el ${type == 'negocio' ? 'negocio' : 'repartidor'}.',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
